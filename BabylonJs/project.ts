...
const csdJson = `
	...
	class TrackNoteActivationSystem extends System {
		...
		#deactivate = (note) => {
			this.track.splice(this.track.indexOf(note), 1)
			this.track.activeNotesChanged = true
		}
