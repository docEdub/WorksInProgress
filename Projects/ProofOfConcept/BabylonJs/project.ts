    ...
    const csdText = `
        ...
        instr 4
            ...
            elseif (iEventType == 3) then
                ...
                kDistanceAmp = min(kDistanceAmp, 0.5)
                ...
                aReverbOut = asig * 2 * kDistanceAmp
                    ...
                    gaInstrumentSignals[0][4] = gaInstrumentSignals[0][4] + aReverbOut
                    gaInstrumentSignals[0][5] = gaInstrumentSignals[0][5] + aReverbOut
                #ifdef IS_GENERATING_JSON
